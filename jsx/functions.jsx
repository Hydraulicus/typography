...
Snap.plugin( function( Snap, Element, Paper, global ) {
    ...
    function addLoadedFrags( whichSVG, fragList, runWhenFinishedFunc, returnVar ) { // This is called once all the loaded frags are complete
        for( let myEl, count = 0; count < fragList.length; count++ ) {
