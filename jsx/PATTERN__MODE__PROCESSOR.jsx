function PATTERN__MODE__PROCESSOR (txt, MODE) {
    ...
    */
    ...
    lineArr.forEach( el => {  el.textContent ="";   });
    ...
    switch (MODE) {
        ...
        case "1" : {
            ...
            ** and stretch lines to width horizontaly
             */
            let subarrays = chunkify(words, 4, true);
            subarrays.forEach( ( el, i) => {
                lineArr[i].textContent = el.join(" ");
            });

            let lines = Snap.selectAll(".changeable__text_place");
            var widths = [];
            lines.forEach( (el, i) => {
        ...
        case "2" : {
            ...
            lines.forEach( (el, i) => {
                ...
                let maxFontSize = 56; //px
                let max_scale_factor = 8;
                ...
                let calculatedFontSize = maxFontSize * scale_factor;
                let calculatedDY = (i == 0) ? 0 : calculatedFontSize*0.7+30; //shifting of next line. 1st line remain at their place
